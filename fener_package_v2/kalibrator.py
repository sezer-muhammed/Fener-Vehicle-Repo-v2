...
class kalibrator(Node):
    ...
    def covariance(self):
        self.imu_temp.orientation_covariance = [cov(self.imu_or_x, self.imu_or_x), cov(self.imu_or_x, self.imu_or_y), cov(self.imu_or_x, self.imu_or_z),
        ...
        self.imu_temp.linear_acceleration_covariance = [cov(self.imu_la_x, self.imu_la_x), cov(self.imu_la_x, self.imu_la_y), cov(self.imu_la_x, self.imu_la_z),
        ...
        self.imu_temp.angular_velocity_covariance = [cov(self.imu_av_x, self.imu_av_x), cov(self.imu_av_x, self.imu_av_y), cov(self.imu_av_x, self.imu_av_z),
    ...
    def timer_callback(self):
        ...
        if self.count == -1:
            self.bno_data_publisher.publish(self.imu_temp)
            rclpy.shutdown()
